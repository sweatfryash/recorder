...
class MyActivityIndicator extends StatefulWidget {
  ...
  /// to 1.0.
  const MyActivityIndicator.partiallyRevealed({
    Key? key,
    this.radius = _kDefaultIndicatorRadius,
    this.progress = 1.0,
  })  : assert(radius > 0.0),
  ...
  @override
  _MyActivityIndicatorState createState() =>
      _MyActivityIndicatorState();
}

class _MyActivityIndicatorState extends State<MyActivityIndicator>
  ...
  @override
  void didUpdateWidget(MyActivityIndicator oldWidget) {
...
class _CupertinoActivityIndicatorPainter extends CustomPainter {
  _CupertinoActivityIndicatorPainter({
    ...
    -radius / _kDefaultIndicatorRadius /1.3,
    -radius / 1.8,
    radius / _kDefaultIndicatorRadius/1.3,
    -radius,
